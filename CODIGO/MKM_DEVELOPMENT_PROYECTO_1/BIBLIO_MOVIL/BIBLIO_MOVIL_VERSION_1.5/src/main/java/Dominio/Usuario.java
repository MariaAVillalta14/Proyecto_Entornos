...
public Socio Registrarse(String nombre,String apellidos,String fecha,String email,String contrasenya1)
{
		Socio misocio;
		
		//Se comentó para poder llevar esto a la clase principal y poder hacer el testings
      /*  
